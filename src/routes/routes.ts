...
import { expressAuthentication } from './../modules/authentication';
...
const models: TsoaRoute.Models = {
    ...
    "NewMessage": {
        "dataType": "refAlias",
        "type": {"ref":"Pick_Message.message_","validators":{}},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
};
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/messages/:messageId',
            ...
            function MessageController_getMessage(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/messages/send',
            ...
            const args = {
                    ...
                    requestBody: {"in":"body","name":"requestBody","required":true,"ref":"NewMessage"},
            };
